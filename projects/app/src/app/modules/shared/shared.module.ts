...
import { CalculatePayoutAmountModalComponent } from './layouts/calculate-payout-amount-modal/calculate-payout-amount-modal.component';
...
@NgModule({
  ...
  declarations: [
    ...
    CalculatePayoutAmountModalComponent,
  ],
