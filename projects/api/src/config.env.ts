...
export const config: { [env: string]: Partial<IServerOptions> } = {
  ...
  local: {
    ...
    email: {
      ...
      defaultSender: {
        email: 'skibasar.olpe@gmail.com',
        name: 'Olper Skibasar',
      },
      mailjet: {
        api_key_public: '1931117a678f5f80b8376cc73458c687',
        api_key_private: 'cdf2428f3e9aa351fe123b17060282f0',
      },
      // defaultSender: {
